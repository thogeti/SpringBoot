...
/**
 * <p>Java class for RxHBBusinessEventEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="RxHBBusinessEventEnum"&gt;
 ...
 * 
 */
@XmlType(name = "RxHBBusinessEventEnum")
@XmlEnum
public enum RxHBBusinessEventEnum {
    ...
    RxHBBusinessEventEnum(String v) {
        value = v;
    }
    ...
    public static RxHBBusinessEventEnum fromValue(String v) {
        for (RxHBBusinessEventEnum c: RxHBBusinessEventEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
