...
@XmlRootElement(name = "RxActiveReminderDeterminationResponse")
public class RxActiveReminderDeterminationResponse {

    @XmlElement(name = "DecisionID", namespace = "http://www.ibm.com/rules/decisionservice/DigitalRxRuleService/RxActiveReminderDetermination", required = true)
