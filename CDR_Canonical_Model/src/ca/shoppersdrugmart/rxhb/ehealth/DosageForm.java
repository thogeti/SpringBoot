...
/**
 * The form in which the drug is marketed for use, typically involving a mixture of active drug components and nondrug components (excipients), along with other non-reusable material that may not be considered an ingredient.
 * 
