...
/**
 * <p>Java class for PharmacyBusinessEventEnum.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="PharmacyBusinessEventEnum"&gt;
 ...
 *     &lt;enumeration value="HW4B Event Added"/&gt;
 *   &lt;/restriction&gt;
 * &lt;/simpleType&gt;
 * </pre>
 * 
 */
@XmlType(name = "PharmacyBusinessEventEnum")
@XmlEnum
public enum PharmacyBusinessEventEnum {
    ...
    @XmlEnumValue("HW4B Event Added")
    HW_4_B_EVENT_ADDED("HW4B Event Added");
    private final String value;

    PharmacyBusinessEventEnum(String v) {
        value = v;
    }
    ...
    public static PharmacyBusinessEventEnum fromValue(String v) {
        for (PharmacyBusinessEventEnum c: PharmacyBusinessEventEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
